...
#define POS_NANOBOT_X       0
#define POS_NANOBOT_Y       0
...
const string PATHS[7] = {FONDO_PATH,NANOBOT_PATH,CELULA_S_PATH,CELULA_X_PATH,CELULA_Y_PATH,CELULA_Z_PATH,ANTICUERPO_PATH};
